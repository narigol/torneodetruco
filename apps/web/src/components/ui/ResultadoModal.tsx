  ...
  return (
    <>
      ...
      <Sheet
        ...
        title={isEdit ? "Editar resultado" : "Cargar resultado"}
          ...
          <>
            ...
            <div className="flex gap-2 mt-5">
              <button
                onClick={submit}
                disabled={loading}
                className="w-full px-3 py-2.5 text-sm bg-red-600 text-white rounded-xl hover:bg-red-700 disabled:opacity-50 transition-colors font-semibold"
              >
