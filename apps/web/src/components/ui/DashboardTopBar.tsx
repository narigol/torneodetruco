        ...
        <div className="flex h-16 items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2 shrink-0">
            <Link
              ...
              className={`relative inline-flex items-center justify-center rounded-full border border-stone-200 bg-white/90 p-2 transition-colors ${
            ...
            >
              ...
              {unreadNotifications > 0 && (
                <span className="absolute -top-1 -right-1 inline-flex min-w-[16px] items-center justify-center rounded-full bg-blue-500 px-1 py-0.5 text-[10px] font-semibold text-white leading-none">
